...
def mag2area_AH17_linear(mw, rtype):
    b = 0.96
    if rtype == 'intra':
        a = -3.89
        sig = 0.19
...
# calculate area (in km**2) 2 mag 
def area2mag_AH17_inter(area):
    from numpy import log10
...
def centroid2rupture(lon, lat, dep, mag, dip, stk):
